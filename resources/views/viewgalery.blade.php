...
<div class="container mx-auto mt-20">
    <div class="flex items-center justify-center py-4 md:py-8 flex-wrap">
        <a href="href=../../../galery"><button type="button" class="text-blue-700 hover:text-white border border-blue-600 bg-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full text-base font-medium px-5 py-2.5 text-center mr-3 mb-3 dark:border-blue-500">All Categories</button></a>
        @foreach($detail as $d)
