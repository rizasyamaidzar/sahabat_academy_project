@extends('admin.admin')
@section('conten')
<h2 class="text-4xl font-bold mb-5 text-blue-950">Category Galery</h2>
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-gradient-to-tl from-blue-900 to-blue-400">
        <div class="m-5">
            <h2 class="text-2xl font-bold text-white mx-3 mb-0">Jumlah Galery</h2>
            <h2 class="text-2xl font-bold text-white text-center">{{ $jumlahGalery }}</h2>
        </div>
        ...
        @foreach($galery as $g)
            <tr class="bg-white border-b hover:bg-gray-50 text-center ">
                ...
                <td class="px-6 py-4 text-center">
                    <a href="/galeryAdmin/{{ $g->nama }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">View user</a>
                </td>
                <td class="px-6 py-4 text-center">
                        <a href="galeryAdmin/{{$g->nama}}/edit" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" >   
                   ...
                   <!-- delete -->
                        <form action="/galeryAdmin/{{ $g->nama  }}" method="post">
                        @method('delete')
                        @csrf
...
<div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form method="POST" action="{{ route('galeryAdmin.store')}}" class="p-4 md:p-5">
                @csrf
